...
var $author$project$Envelope$references = _List_fromArray(
	[
		{
...
var $author$project$Page$Pricing$init = function () {
	var envelopes = $author$project$Envelope$references;
	return {
		envelopes: envelopes,
		format: A2(
			$elm$core$Maybe$map,
			...
			$elm$core$List$head(envelopes)),
		quantity: '1',
		selected: $elm$core$List$head(envelopes)
	};
}();
		...
		switch (msg.$) {
			case 'DidSelectFormat':
				...
				return _Utils_update(
					model,
					{
						format: $elm$core$Maybe$Just(format),
			...
			case 'DidSelectEnvelope':
				...
				return _Utils_update(
					model,
					{
						selected: $elm$core$Maybe$Just(envelope)
					});
			default:
				var quantity = msg.a;
...
var $author$project$Page$Pricing$priceSimulator = F2(
			...
			_List_fromArray(
				[
								...
								]),
							{
								...
								options: A2(
									...
									A2(
										$elm$core$List$filter,
										function (e) {
											return A2($author$project$Envelope$Format$equals, e.format, format_);
										},
										model.envelopes)),
					...
					var format = function (compute) {
						var _v2 = $elm$core$String$toInt(model.quantity);
						if (_v2.$ === 'Nothing') {
							return '- €';
						} else {
							if (!_v2.a) {
...
var $author$project$Page$Pricing$view = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				...
				if (_v0.$ === 'Nothing') {
					...
					var envelope = _v0.a;
					return A2($author$project$Page$Pricing$priceSimulator, model, envelope);
				}
			}()
			]));
};
	...
	switch (page.$) {
		...
		case 'Pricing':
			...
			return A2(
				...
				$author$project$Page$Pricing$view(model));
		default:
			return A2(
				$mdgriffith$elm_ui$Element$textColumn,
				_List_fromArray(
		...
		return A2(
			...
			_List_fromArray(
				[
					...
					_List_Nil,
					{
						label: $author$project$UI$logoWhite(48),
						route: $author$project$Route$Home
					}),
					A2(
					$author$project$Route$link,
