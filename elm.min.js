...
var $author$project$Envelope$references = _Utils_Tuple2(
	{
		...
		format: $author$project$Envelope$Format$Square(130),
	...
	_List_fromArray(
		[
			...
			{
			color: $author$project$Envelope$Color$Ivory,
			format: $author$project$Envelope$Format$Square(140),
			pricing: _Utils_Tuple2(
				0.44,
				_List_fromArray(
					[
...
var $author$project$Page$Upload$Idle = {$: 'Idle'};
var $author$project$Page$Upload$init = $author$project$Page$Upload$Idle;
var $author$project$Main$fromRoute = function (mRoute) {
	if (mRoute.$ === 'Just') {
		switch (mRoute.a.$) {
			...
			default:
				var _v3 = mRoute.a;
				return $author$project$Main$Upload($author$project$Page$Upload$init);
		}
	} else {
...
var $author$project$Envelope$Format$equals = F2(
	...
	function (msg, model) {
		switch (msg.$) {
			case 'DidSelectFormat':
				...
				var mEnvelope = $elm$core$List$head(
					A2(
						...
						function (envelope) {
							return A2($author$project$Envelope$Format$equals, format, envelope.format);
						},
						model.envelopes));
				if (mEnvelope.$ === 'Just') {
					...
					return _Utils_update(
						model,
						{format: format, selected: envelope});
				} else {
					return _Utils_update(
						model,
						{format: format});
			...
			case 'DidInputQuantity':
				var quantity = msg.a;
				return A2($elm$core$String$all, $elm$core$Char$isDigit, quantity) ? _Utils_update(
					model,
...
var $author$project$Page$Upload$Error = function (a) {
	return {$: 'Error', a: a};
};
var $author$project$Page$Upload$GotFile = function (a) {
	return {$: 'GotFile', a: a};
};
var $author$project$Page$Upload$GotFileString = function (a) {
	return {$: 'GotFileString', a: a};
};
var $author$project$Page$Upload$Loaded = function (a) {
	return {$: 'Loaded', a: a};
};
		...
		switch (msg.$) {
			case 'ClickedUpload':
				return _Utils_Tuple2(
					...
					A2(
						...
						_List_fromArray(
							['text/csv']),
						$author$project$Page$Upload$GotFile));
			case 'GotFile':
				var file = msg.a;
				return _Utils_Tuple2(
					model,
					A2(
						$elm$core$Task$perform,
						$author$project$Page$Upload$GotFileString,
			...
			default:
				...
				if (_v1.$ === 'Ok') {
					var rows = _v1.a;
					return _Utils_Tuple2(
						$author$project$Page$Upload$Loaded(
							A2($elm$core$List$filterMap, $author$project$Address$make, rows)),
						$elm$core$Platform$Cmd$none);
				} else {
					var problem = _v1.a;
					return _Utils_Tuple2(
						$author$project$Page$Upload$Error(problem),
						$elm$core$Platform$Cmd$none);
				}
		}
	});
	...
	function (msg, model) {
		...
		switch (msg.$) {
			...
			case 'GotPricingMsg':
				...
				if (_v4.$ === 'Pricing') {
					var subModel = _v4.a;
					var m = A2($author$project$Page$Pricing$update, subMsg, subModel);
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$Pricing(m)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
			...
			default:
				...
				if (_v5.$ === 'Upload') {
					var subModel = _v5.a;
					var _v6 = A2($author$project$Page$Upload$update, subMsg, subModel);
					var m = _v6.a;
					var cmd = _v6.b;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								page: $author$project$Main$Upload(m)
							}),
						A2($elm$core$Platform$Cmd$map, $author$project$Main$GotUploadMsg, cmd));
				} else {
					return _Utils_Tuple2(model, $elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$Page$Pricing$colorOption = function (envelope) {
	return A2(
		$mdgriffith$elm_ui$Element$Input$option,
		envelope,
		A2(
...
var $author$project$Page$Pricing$colorSelect = function (model) {
	return A2(
			...
			]),
		{
			...
			options: A2(
				$elm$core$List$map,
				$author$project$Page$Pricing$colorOption,
				A2(
					$elm$core$List$filter,
					function (e) {
						return A2($author$project$Envelope$Format$equals, e.format, model.format);
					},
					model.envelopes)),
			selected: $elm$core$Maybe$Just(model.selected)
		});
};
...
var $author$project$Envelope$Format$toString = function (format) {
	if (format.$ === 'Square') {
		var size = format.a;
		return 'Carrée ' + ($elm$core$String$fromInt(size) + (' x ' + ($elm$core$String$fromInt(size) + ' mm')));
	} else {
		var height = format.a;
		var width = format.b;
		return 'Rectangle ' + ($elm$core$String$fromInt(height) + (' x ' + ($elm$core$String$fromInt(width) + ' mm')));
	}
};
...
var $author$project$UI$Color$Tailwind$blue800 = $author$project$UI$Color$hexToColor(1982639);
...
var $author$project$Page$Pricing$preview = F4(
	function (scaleFontSize, size, envelope, font) {
		var oneCmToPx = function () {
			var _v0 = envelope.format;
			if (_v0.$ === 'Square') {
				var s = _v0.a;
				return ((size * 10) / s) | 0;
			} else {
		...
		var fontSize = ((size * font.previewSize) / 500) | 0;
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
						...
						[
							...
							A2(
								...
								_List_fromArray(
									[
										...
										$mdgriffith$elm_ui$Element$moveUp(size / 3.5),
										$mdgriffith$elm_ui$Element$moveLeft(size / 6.5),
										...
										$mdgriffith$elm_ui$Element$width($mdgriffith$elm_ui$Element$shrink),
										$mdgriffith$elm_ui$Element$Font$color($author$project$UI$Color$Tailwind$blue800),
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text('Monsieur et Madame MACRON')
											])),
										A2(
										$mdgriffith$elm_ui$Element$paragraph,
										_List_Nil,
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text('55 Rue du Faubourg Saint-Honoré')
											])),
										A2(
										$mdgriffith$elm_ui$Element$paragraph,
										_List_Nil,
										_List_fromArray(
											[
												$mdgriffith$elm_ui$Element$text('75008 PARIS')
											]))
									]))),
							A2(
							$mdgriffith$elm_ui$Element$column,
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$alignRight,
									$mdgriffith$elm_ui$Element$width(
									$mdgriffith$elm_ui$Element$px(oneCmToPx))
								]),
							_List_fromArray(
								[
									A2(
						...
						[
							...
							_List_fromArray(
								[
									...
									$mdgriffith$elm_ui$Element$transparent(font.isAllCapsCompatible)
								]),
							_List_fromArray(
								[
	...
	return A2(
		...
		_List_fromArray(
			[
				...
				var computeSubTotal = $author$project$Envelope$Pricing$total(model.selected.pricing);
				return A2(
					$mdgriffith$elm_ui$Element$column,
					_List_fromArray(
						[
						...
						[
							...
							_List_fromArray(
								[
									...
									$author$project$Page$Pricing$colorSelect(model),
									A2($author$project$Page$Pricing$fontSelect, model.fonts, model.font)
								])),
							A4($author$project$Page$Pricing$preview, 8, screenWidth - 32, model.selected, model.font),
								...
								[
									...
									_List_fromArray(
										[
											...
											A4($author$project$Page$Pricing$preview, 12, 400, model.selected, model.font)
										])),
									$author$project$Page$Pricing$quantityAndPrices(model),
									callUs
								]))
								...
								[
									...
									_List_fromArray(
										[
											...
											A4($author$project$Page$Pricing$preview, 12, 500, model.selected, model.font),
											A2($author$project$Page$Pricing$fontSelect, model.fonts, model.font)
										])),
									$author$project$Page$Pricing$quantityAndPrices(model),
									callUs
...
var $author$project$Page$Upload$ClickedUpload = {$: 'ClickedUpload'};
...
var $author$project$Page$Upload$textIfNotEmpty = function (string) {
...
var $author$project$Page$Upload$addressView = function (_v0) {
	var name = _v0.name;
	var street = _v0.street;
	var streetLine2 = _v0.streetLine2;
	var postalCode = _v0.postalCode;
	var city = _v0.city;
	...
	return A2(
		...
		_List_fromArray(
			[
				$mdgriffith$elm_ui$Element$spacing(4),
				$mdgriffith$elm_ui$Element$padding(16),
				A2($mdgriffith$elm_ui$Element$Border$glow, $author$project$UI$Color$Tailwind$warmGray200, 4),
		...
		_List_fromArray(
			[
				...
				$author$project$Page$Upload$textIfNotEmpty(streetLine2),
				A2(
				$mdgriffith$elm_ui$Element$row,
				_List_fromArray(
					[
				...
				_List_fromArray(
					[
						$mdgriffith$elm_ui$Element$text(postalCode),
						$mdgriffith$elm_ui$Element$text(city)
					])),
				$author$project$Page$Upload$textIfNotEmpty(country)
			]));
};
...
var $author$project$UI$Color$primary550 = $author$project$UI$Color$hexToColor(15096410);
...
var $author$project$Page$Upload$view = function (model) {
	switch (model.$) {
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$Background$color($author$project$UI$Color$primary550)
							]))
					]),
				{
					label: $mdgriffith$elm_ui$Element$text('Charger'),
					onPress: $elm$core$Maybe$Just($author$project$Page$Upload$ClickedUpload)
				});
		case 'Loading':
			return A2(
				$mdgriffith$elm_ui$Element$el,
		...
		case 'Loaded':
			if (!model.a.b) {
				return $mdgriffith$elm_ui$Element$text('empty');
			} else {
				var rows = model.a;
				return A2(
					...
					_List_fromArray(
						[
							$mdgriffith$elm_ui$Element$padding(32),
							A2($mdgriffith$elm_ui$Element$spacingXY, 16, 8)
						]),
					{
						columns: _List_fromArray(
							[
								{header: $mdgriffith$elm_ui$Element$none, view: $author$project$Page$Upload$addressView, width: $mdgriffith$elm_ui$Element$shrink}
							]),
						data: rows
					});
			}
		default:
			var problem = model.a;
			if (problem.$ === 'SourceEndedWithoutClosingQuote') {
				return $mdgriffith$elm_ui$Element$text('Source ended without cloding quote');
			} else {
				return $mdgriffith$elm_ui$Element$text('Additional characters after closing quote');
			}
	}
};
	...
	switch (page.$) {
		...
		case 'Upload':
			...
			return A2(
				...
				$author$project$Page$Upload$view(model));
		default:
			return A2(
				$mdgriffith$elm_ui$Element$textColumn,
				_List_fromArray(
