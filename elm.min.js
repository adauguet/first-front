...
var $author$project$UI$Color$primary = A3($mdgriffith$elm_ui$Element$rgb255, 255, 100, 100);
...
var $author$project$UI$callLinkAttributes = _List_fromArray(
	[
		$mdgriffith$elm_ui$Element$Background$color($author$project$UI$Color$primary),
			...
			[
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$Font$color($author$project$UI$Color$primary),
						$mdgriffith$elm_ui$Element$Font$family(
						_List_fromArray(
							[
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Vous pouvez aussi ajouter une adresse manuellement.')
							]))
					]))
			]));
			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Choisissez aussi la couleur en accord avec celle de votre enveloppe et de votre thème.')
							]))
					]))
			]));
...
var $author$project$Page$Pricing$quantityAndPrices = F2(
	function (model, envelope) {
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					...
					var computeSubTotal = $author$project$Envelope$Pricing$total(envelope.pricing);
					return A2(
						$mdgriffith$elm_ui$Element$column,
						_List_fromArray(
							[
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						A2($author$project$Page$Pricing$quantityAndPrices, model, model.selected),
						callUs
					]));
		} else {
			return A2(
