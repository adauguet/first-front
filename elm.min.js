...
var $author$project$Page$Pricing$Ivory = {$: 'Ivory'};
var $author$project$Page$Pricing$Square = function (a) {
	return {$: 'Square', a: a};
};
var $author$project$Pricing$Step = F2(
	function (fromQuantity, price) {
		return {fromQuantity: fromQuantity, price: price};
	});
var $author$project$Page$Pricing$init = _List_fromArray(
	[
		_Utils_Tuple2(
		'',
		{
			color: $author$project$Page$Pricing$Ivory,
			format: $author$project$Page$Pricing$Square(140),
			pricing: _Utils_Tuple2(
				0.44,
				_List_fromArray(
					[
						A2($author$project$Pricing$Step, 50, 0.38),
						A2($author$project$Pricing$Step, 200, 0.3),
						A2($author$project$Pricing$Step, 1000, 0.26)
					]))
		})
	]);
...
var $author$project$Page$Pricing$update = F2(
	function (msg, model) {
		var index = msg.a;
		var value = msg.b;
		if (A2($elm$core$String$all, $elm$core$Char$isDigit, value)) {
			var _v1 = A2($elm_community$list_extra$List$Extra$getAt, index, model);
			if (_v1.$ === 'Just') {
				var _v2 = _v1.a;
				var envelope = _v2.b;
				return A3(
...
var $author$project$Page$Pricing$InputTestValue = F2(
	function (a, b) {
		return {$: 'InputTestValue', a: a, b: b};
	});
var $author$project$Page$Pricing$colorToString = function (color) {
	return 'Ivoire';
};
var $author$project$Page$Pricing$formatToString = function (format) {
	var size = format.a;
	return 'Carrée ' + ($elm$core$String$fromInt(size) + (' x ' + $elm$core$String$fromInt(size)));
};
var $author$project$Range$Range = F3(
	function (from, to, price) {
		return {from: from, price: price, to: to};
	});
var $author$project$Range$compute = F3(
	function (current, _v0, ranges) {
		var p = _v0.a;
		var steps = _v0.b;
		if (!steps.b) {
			return A2(
				$elm$core$List$cons,
				A3($author$project$Range$Range, current, $elm$core$Maybe$Nothing, p),
				ranges);
		} else {
			...
			return A2(
				$elm$core$List$cons,
				A3(
					$author$project$Range$Range,
					current,
					$elm$core$Maybe$Just(fromQuantity - 1),
					p),
				A3(
					$author$project$Range$compute,
					fromQuantity,
					_Utils_Tuple2(price, xs),
					ranges));
		}
	});
var $author$project$Range$fromPricing = function (pricing) {
	return A3($author$project$Range$compute, 1, pricing, _List_Nil);
};
...
var $author$project$Pricing$rate = F3(
...
var $author$project$Pricing$total = F2(
	function (quantity, _v0) {
		var base = _v0.a;
		var steps = _v0.b;
		return quantity * A3($author$project$Pricing$rate, quantity, base, steps);
	});
var $author$project$Page$Pricing$enveloppeView = F2(
	function (index, _v0) {
		var quantity = _v0.a;
		var format = _v0.b.format;
		var color = _v0.b.color;
		var pricing = _v0.b.pricing;
		return A2(
			$mdgriffith$elm_ui$Element$column,
			_List_fromArray(
				[
			...
			_List_fromArray(
				[
					$mdgriffith$elm_ui$Element$text(
					$author$project$Page$Pricing$formatToString(format)),
					$mdgriffith$elm_ui$Element$text(
					$author$project$Page$Pricing$colorToString(color)),
					A2(
					$mdgriffith$elm_ui$Element$table,
					_List_fromArray(
						[
							A2($mdgriffith$elm_ui$Element$spacingXY, 32, 8)
						]),
					{
								...
								view: function (_v1) {
									...
									return $mdgriffith$elm_ui$Element$text(
										function () {
											if (to.$ === 'Just') {
												var to_ = to.a;
												return $elm$core$String$fromInt(from) + (' - ' + $elm$core$String$fromInt(to_));
											} else {
												return $elm$core$String$fromInt(from) + ' +';
											}
										}());
								},
						...
						data: $author$project$Range$fromPricing(pricing)
					}),
					A2(
					...
					_List_Nil,
					{
						...
						onChange: $author$project$Page$Pricing$InputTestValue(index),
						placeholder: $elm$core$Maybe$Nothing,
						text: quantity
					}),
					function () {
					var _v4 = $elm$core$String$toInt(quantity);
					if (_v4.$ === 'Just') {
						var _int = _v4.a;
						return $mdgriffith$elm_ui$Element$text(
							$elm$core$String$fromFloat(
								A2($author$project$Pricing$total, _int, pricing)) + ' €');
					} else {
		...
		_List_fromArray(
			[
				...
				_List_Nil,
				{
					columns: _List_fromArray(
						[
							{header: $mdgriffith$elm_ui$Element$none, view: $author$project$Page$Pricing$enveloppeView, width: $mdgriffith$elm_ui$Element$shrink}
						]),
					data: model
				})
			]));
