...
var $author$project$Page$Pricing$allFonts = _Utils_Tuple2(
	'Amatic SC',
	_List_fromArray(
		['Annie Use Your Telescope', 'Bilbo', 'Caveat', 'Coming Soon', 'Dancing Script', 'Gaegu', 'Hi Melody', 'Loved by the King', 'Mr De Haviland', 'Nanum Brush Script', 'Over the Rainbow', 'Stalemate', 'Sue Ellen Fransisco', 'Waiting for the Sunrise']));
...
var $author$project$Page$Pricing$init = function () {
	...
	var x = _v0.a;
	var xs = _v0.b;
	var _v1 = $author$project$Page$Pricing$allFonts;
	var f = _v1.a;
	var fs = _v1.b;
	return {
								...
								A2(
									...
									_List_fromArray(
										[
											...
											_List_fromArray(
												[
													$mdgriffith$elm_ui$Element$Font$typeface(font)
												]))
										]),
									$mdgriffith$elm_ui$Element$text(font)));
						},
						model.fonts),
			...
			A2(
				...
				_List_fromArray(
					[
						...
						$mdgriffith$elm_ui$Element$moveUp(size / 4),
						$mdgriffith$elm_ui$Element$moveLeft(size / 6),
						...
						$mdgriffith$elm_ui$Element$Font$size((size / 22) | 0)
					]),
				_List_fromArray(
					[
						A2(
				...
				[
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$mdgriffith$elm_ui$Element$text('Pour passer commande, appelez-nous 😉')
								]))
						])),
					A2(
					$mdgriffith$elm_ui$Element$el,
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						A3($author$project$Page$Pricing$preview, screenWidth - 32, model.selected, model.font),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Page$Pricing$choices(model),
										A3($author$project$Page$Pricing$preview, 500, model.selected, model.font)
									])),
								A2($author$project$Page$Pricing$quantityAndPrices, model, model.selected),
								callUs
							]))
