...
var $author$project$Page$Pricing$preview = F2(
	function (size, envelope) {
		return A2(
			$mdgriffith$elm_ui$Element$el,
			_List_fromArray(
				[
			...
			A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Monsieur et Madame DAUGUET')
							])),
						A2(
						$mdgriffith$elm_ui$Element$paragraph,
						_List_Nil,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('2 impasse du Clos du Vieux Chêne')
							])),
						A2(
						$mdgriffith$elm_ui$Element$paragraph,
						_List_Nil,
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('35800 DINARD')
							]))
					])));
	});
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						A2($author$project$Page$Pricing$preview, screenWidth - 32, model.selected),
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$author$project$Page$Pricing$choices(model),
										A2($author$project$Page$Pricing$preview, 500, model.selected)
									])),
								A2($author$project$Page$Pricing$quantityAndPrices, model, model.selected),
								callUs
							]))
