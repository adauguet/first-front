			...
			[
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$mdgriffith$elm_ui$Element$text('Plusieurs formats sont possibles : '),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
								...
								$mdgriffith$elm_ui$Element$text('.xls')),
								...
								$mdgriffith$elm_ui$Element$text('.xlsx')),
								$mdgriffith$elm_ui$Element$text(', ou '),
								A2(
								$mdgriffith$elm_ui$Element$el,
								_List_fromArray(
									[
								...
								$mdgriffith$elm_ui$Element$text('.csv')),
								$mdgriffith$elm_ui$Element$text('.')
							]))
					]))
			]));
...
var $author$project$Page$Pricing$choices = function (model) {
	return A2(
		$mdgriffith$elm_ui$Element$column,
		_List_fromArray(
			[
			...
			[
					...
					]),
				{
					...
					options: A2(
						...
						model.fonts),
					selected: $elm$core$Maybe$Just(model.font)
				})
			]));
};
			...
			return A2(
				...
				_List_fromArray(
					[
						...
						$author$project$Page$Pricing$choices(model),
